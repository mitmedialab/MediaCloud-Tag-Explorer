...
def addSourceNameToStory(db_story, raw_story):
    '''
    This pulls the media name from the CSV included in the api module, adding it as metadata
    to the story to be saved 
    '''
